        ...
        <Grid item xs={12} md={6}>
          <Box className="detail-section">
            ...
            <Typography variant="body2" className="product-description">
              The design makes it easy to put the tray back after use since you
              place it directly on the table frame without having to fit it into
              any holes.
            </Typography>
            <Typography variant="body2" className="product-description">
              You can use the removable tray for serving. The tray's edges make
              it easy to carry and reduce the risk of glasses sliding off.
            </Typography>
            <Typography variant="body2" className="product-description">
              Only for indoor use.
            </Typography>
